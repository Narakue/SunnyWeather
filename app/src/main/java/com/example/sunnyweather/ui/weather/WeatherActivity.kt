...
import com.example.sunnyweather.logic.model.weather.getSky
...
class WeatherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        // TODO super.onCreate(savedInstanceState, persistentState)
    ...
    private fun showWeatherInfo(weather: Weather) {
        ...
        nowLayout.setBackgroundResource(getSky(realtime.skycon).bg) // 填充forecast.xml布局中的数据
